...
if ($title == "" || $cat == "" || $body == "" || $tags == "" || $author == "") {
    ...
    if ($inserted_rows) {
     echo "<span style='color:green;font-size: 20px;'>Post Inserted Successfully.
     </span>";

    }else {
     echo "<span style='color:red;font-size: 20px;'>Post Not Inserted !</span>";
    }
         ...
         <form action="addpost.php" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <input readonly type="text" name="author" value="<?php echo Session::get('username') ?>" class="medium" />
