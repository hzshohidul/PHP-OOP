    ...
    if (!empty($file_name)) {
        ...
        if ($file_size >1048567) {
         ...
         .implode(', ', $permited)."</span>";
            ...
            if ($updated_row) {
             echo "<span style='color:green;font-size: 20px;'>Post Updated Successfully.
             </span>";

            }else {
             echo "<span style='color:red;font-size: 20px;'>Post Not Updated !</span>";
            }
