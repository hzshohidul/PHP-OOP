...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $details   = mysqli_real_escape_string($db->link, $_POST['details']);
        ...
        $query = "UPDATE tbl_user
                ...
                if ($updated_row) {
                 echo "<span style='color:green;font-size: 20px;'>User Data Updated Successfully.
                 </span>";

                }else {
                 echo "<span style='color:red;font-size: 20px;'>User Data Not Updated !</span>";
                }
        }
?>
<div class="block"> 
